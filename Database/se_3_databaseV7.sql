...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 01, 2023 at 08:21 PM
...
(1, 'บ้านพักพิงฯ เพื่อครอบครัวผู้ป่วยเด็ก', 'ร่วมสนับสนุนพ่อแม่ให้ได้อยู่ใกล้ชิดลูกที่ป่วยขั้นวิกฤตขณะเข้ารับการรักษาในโรงพยาบาล เพื่อลดปัญหาการแอบหลับนอนตามพื้นที่สาธารณะ พัฒนาคุณภาพชีวิตของครอบครัวผู้ป่วยเด็กให้ดีขึ้น', 'ACTIVE', NULL),
...
(2, 2000, 0, ''),
(3, 3000, 0, ''),
(28, 1231410, 99999, '061fc738d46ba9dd0476a124bd386790.jpg');
...
(2, 123, 'REQUEST', 1, 16, '11:48', '2023-04-07', '1043543.png');
...
INSERT INTO `progress` (`Id`, `Number`, `Name`, `Description`, `Date`, `Image`, `campaign_money_id`) VALUES
...
(14, 'Chalermchai', 'Kamlungdach', 'chalermchaikm@gmail.com', 'chalermchaikm@gmail.com', NULL, NULL, '$2y$10$nFuUSoys//XIJMeAliGF6e6h7NiYxsgRQgWsdpyDKU/giDt8VwlVa', 'APPROVE', 'USER', NULL, NULL, NULL, '2023-03-30 01:12:14', '2023-03-30 01:12:14', 'user-thumb.jpg'),
