...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2023 at 03:25 PM
...
(1, 'บ้านพักพิงฯ เพื่อครอบครัวผู้ป่วยเด็ก', 'ร่วมสนับสนุนพ่อแม่ให้ได้อยู่ใกล้ชิดลูกที่ป่วยขั้นวิกฤตขณะเข้ารับการรักษาในโรงพยาบาล เพื่อลดปัญหาการแอบหลับนอนตามพื้นที่สาธารณะ พัฒนาคุณภาพชีวิตของครอบครัวผู้ป่วยเด็กให้ดีขึ้น', 'ACTIVE', NULL, 'https://media-cdn.tripadvisor.com/media/photo-s/10/c4/23/16/highland-view-bed-and.jpg'),
(2, 'Chef Scholarship ปั้นเด็กให้เป็นเชฟ', 'เพิ่มโอกาสเด็กๆนอกระบบที่มีฝันอยากเป็นเชฟ แต่มีข้อจำกัดของฐานะทางการเงิน ให้สามารถทำตามความฝันด้วยการสนับสนุนทุนฝึกงานในร้านอาหารขึ้นชื่อ เพื่อเรียนรู้กษะ ฝึกประสบการณ์ในสถานประกอบการมืออาชีพ เพื่อต่อยอดLocal chef ให้น้อง ๆ ที่อยากมีอาชีพที่บ้าน', 'FINISHED', NULL, 'https://media-cdn.tripadvisor.com/media/photo-s/10/c4/23/16/highland-view-bed-and.jpg'),
(3, 'Allympic มหกรรมกีฬาแห่งมวลมนุษยชาติ... ทุกคน', 'เพราะการเข้าถึงสุขภาพที่ดี ไม่ควรมีข้อจำกัด... เราจึงระดมทุนจัดงาน Allympic เพื่อสร้าง มหกรรมกีฬาแห่งมวลมนุษยชาติให้ทุกคนสามารถเล่นกีฬาด้วยกัน ไม่ว่าจะพิการหรือไม่พิการ ทุกคนจะได้เล่นกีฬาด้วยกันภายใต้กติกาเดียวกันที่มีความเสมอภาค โดยมีเป้าหมายคนเข้าร่วมกิ', 'TERMINATE', NULL, 'https://media-cdn.tripadvisor.com/media/photo-s/10/c4/23/16/highland-view-bed-and.jpg'),
(4, 'เก่าไม่ไหว ขอคู่ใหม่ให้หนูที', 'มอบรองเท้านักเรียนคู่ใหม่ให้เด็กนักเรียนยากจนในโรงเรียนชนบท เพื่อป้องกันความเสี่ยงจากอุบัติเหตุ และโรคต่างๆที่เกิดจากการสวมใส่รองเท้านักเรียนที่มีสภาพเก่าขาดชำรุด สร้างเสริมสุขลักษณะที่ดี และสร้างแรงบันดาลใจในการไปโรงเรียนให้แก่เด็กๆที่ขาดแคลน', 'ACTIVE', NULL, 'https://media-cdn.tripadvisor.com/media/photo-s/10/c4/23/16/highland-view-bed-and.jpg'),
(5, 'ช้างอิ่มท้อง พี่น้องเกษตรกรอิ่มใจ', 'ช้างขาดแคลนอาหาร เพราะปางช้างหลายแห่งกำลังเผชิญกับปัญหาเศรษฐกิจที่แม้ดิ้นรนเพียงใด ก็ไม่เพียงพอ มูลนิธิอนุรักษ์ช้างเอเชียชวนทุกคนมาช่วยบริจาคซื้อกล้วยอ้อย ข้าวโพด เพื่อเลี้ยงช้างอิ่มท้อง ใน 30 ปางช้าง พร้อมพี่น้องเกษตรกรอิ่มใจกัน', 'FINISHED', NULL, 'https://media-cdn.tripadvisor.com/media/photo-s/10/c4/23/16/highland-view-bed-and.jpg'),
(6, 'ช่วยเหลือแม่และเด็กที่ถูกกระทำด้วยความรุนแรงในครอบ', 'ความรุนแรงในครอบครัวเป็นปัญหาที่เกิดขึ้นในทุกประเทศทั่วโลกโดยไม่เลือกเชื้อชาติ สัญชาติ ความเชื่อ การศึกษาหรือฐานะทางสังคม ปัญหาความรุนแรงในครอบครัวได้ส่งผลก่อให้เกิดความเจ็บปวดสูญเสียทั้งทางร่างกาย จิตใจ อารมณ์และทรัพย์สินแก่ผู้ถูกกระทำ บุคคลที่เกี่ยวข้อง', 'TERMINATE', NULL, 'https://media-cdn.tripadvisor.com/media/photo-s/10/c4/23/16/highland-view-bed-and.jpg'),
(28, 'adfa', 'abdc', 'ACTIVE', NULL, 'https://media-cdn.tripadvisor.com/media/photo-s/10/c4/23/16/highland-view-bed-and.jpg'),
(36, 'adfa', 'abdc', 'ACTIVE', NULL, 'https://media-cdn.tripadvisor.com/media/photo-s/10/c4/23/16/highland-view-bed-and.jpg'),
(37, 'โครงการทดสอบ2', 'โครงการทดสอบ2', 'ACTIVE', NULL, 'https://media-cdn.tripadvisor.com/media/photo-s/10/c4/23/16/highland-view-bed-and.jpg'),
(39, 'ทดสอบ', 'ผ่านเถอะ', 'ACTIVE', NULL, 'https://media-cdn.tripadvisor.com/media/photo-s/10/c4/23/16/highland-view-bed-and.jpg'),
(48, 'testm', 'testm', 'ACTIVE', NULL, '061fc738d46ba9dd0476a124bd386790.jpg'),
(54, 'afafa', 'agaga', 'ACTIVE', NULL, '061fc738d46ba9dd0476a124bd386790.jpg'),
(56, 'test2', 'test2', 'ACTIVE', NULL, '061fc738d46ba9dd0476a124bd386790.jpg'),
(57, 'testtttt', 'testttt', 'ACTIVE', NULL, 'Sono.Bisque.Doll.wa.Koi.wo.Suru.full.2776526.jpg');
